                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          ...
                                          <p class="m-b-0">Halaman Data Tim</p>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Data Tim</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Data Tim</h5>
                                                <br>
                                                <a href="{{ route('tim.create') }}" class="btn btn-primary">Tambah Data</a>
                                            </div>
                                                    ...
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th scope="col">Lokasi Tim</th>
                                                                <th scope="col">Pemimpin Tim</th>
                                                                <th scope="col">Kontak Tim</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($tim as $data)
                                                                <tr>
                                                                    <th scope="row">{{ $no++ }}</th>
                                                                    <th>{{ $data->kode_tim }}</th>
                                                                    <th>{{ $data->nama_anggota_tim }}</th>
                                                                    <th>{{ $data->lokasi_tim }}</th>
                                                                    <th>{{ $data->pemimpin_tim }}</th>
                                                                    <th>{{ $data->kontak_tim }}</th>
                                                                    <td>
                                                                        <form action="{{ route('tim.destroy', $data->id) }}" method="POST">
                                                                        <a href="{{ route('tim.edit', $data->id) }}" class="btn btn-success">Edit</a>
                                                                            @csrf
                                                                            @method('DELETE')
