                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('tim.store') }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_anggota_tim">
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-12 col-form-label">Pemimpin</label>
                                                    <input type="text" class="form-control" name="pemimpin_tim">
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-12 col-form-label">Lokasi</label>
                                                    <input type="text" class="form-control" name="lokasi_tim">
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-12 col-form-label">Kontak</label>
                                                    <input type="text" class="form-control" name="kontak_tim">
                                                </div>
