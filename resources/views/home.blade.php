                                            ...
                                            <div class="col-xl-4 col-md-7">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">{{ \App\Models\BarangMasuk::count() }}</h4>
                                            ...
                                            <div class="col-xl-4 col-md-7">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-red ">{{ \App\Models\Barangkeluar::count() }}</h4>
                                            ...
                                            <div class="col-xl-4 col-md-7">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">{{ \App\Models\Peminjaman::count() }}</h4>
