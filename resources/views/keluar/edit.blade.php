...
<head>
    <title>Barang Keluar | Edit</title>
                              ...
                              <div class="row align-items-center">
                                  ...
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="{{ route('barangkeluar.index') }}">Barang Keluar</a>
                                          </li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Jumlah</label>
                                                <input type="number" class="form-control" value="{{ $barangkeluar->jumlah }}" name="jumlah">
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal Keluar Barang</label>
                                                <input type="date" class="form-control" value="{{ $barangkeluar->tanggal_keluar }}" name="tanggal_keluar">
                                            </div>
                                            <div class="form-group">
